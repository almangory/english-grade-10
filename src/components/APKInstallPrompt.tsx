...
export default function APKInstallPrompt({ isOpen, onClose }: APKInstallPromptProps) {
  ...
  const compilingSteps = [
    "جاري قراءة ملفات منهج SMILE Grade 10...",
...
<head>
    ...
    <title>SMILE English Grade 10 - Launcher</title>
    <style>
...
<body>
    <div class="card">
        <h2>SMILE English Grade 10 🇸🇩</h2>
        <p>مرحباً بك! هذا ملف تشغيل سريع لتطبيق منهج الصف الأول الثانوي.</p>
      ...
      a.href = url;
      a.download = "SMILE_English_Grade_10_Sudan.html";
